...
return (
    <SafeAreaView className="flex-1 bg-slate-950">
        ...
        >
            <View className="flex-1 bg-slate-950/90 justify-end">
                <View className="bg-slate-900 rounded-t-3xl border-t border-slate-800 h-[70%]">
                    ...
                    <ScrollView className="flex-1 p-6">
                        <View className="space-y-4 pb-12">
                            ...
                            <View>
                                <Text className="text-slate-400 font-bold text-xs uppercase mb-2">Description</Text>
                                <TextInput
                                    className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-white font-medium h-24"
                                    value={description}
                                    onChangeText={setDescription}
                                    placeholder="Briefly describe the feat..."
                                    placeholderTextColor="#475569"
